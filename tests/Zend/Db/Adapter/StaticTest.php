...
class Zend_Db_Adapter_StaticTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDbFactoryAlternateNamespaceExceptionInvalidAdapter()
    {
        ...
        try {
            $db = Zend_Db::factory('Validate', array('dbname' => 'dummy', 'adapterNamespace' => 'Zend'));
            set_include_path($ip);
            ...
            $this->assertEquals("Adapter class 'Zend_Validate' does not extend Zend_Db_Adapter_Abstract", $e->getMessage());
        }
    }
